            ...
            <label class="list-group-item">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-2">
                            <SortColumnLink column-name="count" text="Count" title="Sort Count" v-on:click="sort" />
                        </div>
                        <div class="col-8">
                            <SortColumnLink column-name="name" text="Name" title="Sort Name" v-on:click="sort" />
                        </div>
                    </div>
                </div>
            </label>
            <label v-for="node in rawMaterials" :key="node.ItemID" class="list-group-item">
                <div class="container">
                    <div class="row">
                        <div class="col-2">
                            <input
                        ...
                        <div class="col-2">
                            <span class="badge rounded-pill bg-secondary">{{ node.value }}</span>
                        </div>
                        <div class="col-8">
